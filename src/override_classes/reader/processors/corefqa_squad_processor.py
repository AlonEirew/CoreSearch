...
class CorefQASquadProcessor(SquadProcessor):
    def __init__(self, tokenizer, max_seq_len: int, data_dir: Optional[Union[Path, str]], add_special_tokens=False,
        ...
        super(CorefQASquadProcessor, self).__init__(tokenizer, max_seq_len, data_dir, **kwargs)
    ...
    def convert_from_transformers(cls, tokenizer_name_or_path, task_type, max_seq_len, doc_stride,
        ...
        if task_type == "question_answering":
            processor = CorefQASquadProcessor(
                tokenizer=tokenizer,
    ...
    def _passages_to_pytorch_features(self, baskets:List[SampleBasket], return_baskets:bool):
        ...
        for basket in baskets:
            ...
            for num, sample in enumerate(basket.samples): # type: ignore
                ...
                input_ids, padding_mask, segment_ids, seq_2_start_t, span_mask, start_of_word = self.create_query_pass_ids(
                    passage_input_ids, passage_len_t, passage_start_of_word, question_input_ids, question_len_t,
                    question_start_of_word)

                alt_input_ids, alt_padding_mask, alt_segment_ids, \
                alt_seq_2_start_t, alt_span_mask, alt_start_of_word = self.create_query_pass_ids(
                    question_input_ids, question_len_t, question_start_of_word, passage_input_ids, passage_len_t,
                ...
                if len(basket.raw['answers']) > 0:
                    ...
                    if answer_text != '' and sample.tokenized["labels"][0][0] != 0 and sample.tokenized["labels"][0][
                        1] - 1 != 0:
                ...
                if len_check and id_check and label_check and label_check2:
                    ...
                    feature_dict = {"input_ids": input_ids,
                                    ...
                                    "alt_padding_mask": alt_padding_mask,
                                    "alt_segment_ids": alt_segment_ids,
                                    ...
                                    "alt_seq_2_start_t": alt_seq_2_start_t,
                                    "span_mask": span_mask,
                                    "alt_span_mask": alt_span_mask,
    ...
    def create_query_pass_ids(self, passage_input_ids, passage_len_t, passage_start_of_word, question_input_ids,
                              question_len_t, question_start_of_word):
        ...
        return input_ids, padding_mask, segment_ids, seq_2_start_t, span_mask, start_of_word
